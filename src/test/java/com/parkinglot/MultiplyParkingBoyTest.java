...
public class MultiplyParkingBoyTest {
    @Test
    public void should_park_first_parkingLot_when_fetch_given_two_parkingLots() {
        //Given
    ...
    @Test
    public void should_park_second_parkingLot_when_fetch_given_two_parkingLots() {
        //Given
    ...
    @Test
    public void should_return_right_car_when_fetch_given_two_parkingLots() {
        //Given
        ParkingLot parkingLot1 = new ParkingLot(1, 1);
        ParkingLot parkingLot2 = new ParkingLot(2, 1);
        ParkingBoy parkingBoy = new ParkingBoy();
